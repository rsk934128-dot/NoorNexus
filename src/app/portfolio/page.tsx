...
import { Briefcase, ExternalLink, ShieldCheck, Sparkles, RefreshCcw } from "lucide-react"
import { Badge } from "@/components/ui/badge"
import { Button } from "@/components/ui/button"

/**
 * @fileOverview Imperial Portfolio Page
 * This page integrates the Sheikh Tech Portfolio into the NoorNexus Sovereign OS.
 */
        ...
        <main className="flex flex-col h-screen w-full max-w-full overflow-hidden p-0 m-0 relative">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-[10px] text-muted-foreground font-mono tracking-widest uppercase truncate">Sovereign Talent Showcase</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Badge variant="outline" className="hidden sm:flex border-emerald-500/50 text-emerald-500 uppercase items-center gap-1.5 h-7">
                ...
                <span className="text-[10px]">Verified Architect</span>
              </Badge>
              <Button 
                variant="ghost" 
                size="icon" 
              ...
              <a 
                href="https://sheikh-tech-portfolio-showcase.vercel.app/" 
                target="_blank" 
          ...
          <div className="flex-1 overflow-hidden bg-black/20 w-full p-0 m-0">
            <Card className="border-none h-full w-full overflow-hidden relative rounded-none shadow-none bg-transparent m-0 p-0">
              ...
              <CardContent className="p-0 h-full w-full">
                <iframe 
                  id="portfolio-iframe"
                  src="https://sheikh-tech-portfolio-showcase.vercel.app/" 
                  className="w-full h-full border-0 bg-white"
                  title="Sheikh Tech Portfolio Showcase"
          ...
          <footer className="py-2 border-t border-white/5 bg-background/80 shrink-0 text-center w-full">
            <p className="text-[9px] font-mono text-muted-foreground uppercase tracking-[0.4em]">
              NoorNexus OS Archive Node | Endpoint: portfolio-showcase
            </p>
          </footer>
        </main>
      </SidebarInset>
