          ...
          <header className="relative space-y-6">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 border-b border-white/5 pb-10">
              <div className="space-y-4 w-full">
                ...
                <p className="text-muted-foreground max-w-3xl text-xs sm:text-xl leading-relaxed italic">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full lg:w-auto">
                <Card className="sovereign-stats-card bg-emerald-500/5 border-emerald-500/20 w-full sm:w-auto">
                    <div className="flex justify-between items-center mb-2 sm:mb-4">
                       <p className="text-[8px] sm:text-[10px] font-bold text-emerald-500 uppercase tracking-widest">Cognitive Pulses</p>
                    </div>
                    <div className="flex items-end gap-2 mb-2 sm:mb-4">
                       <p className="text-3xl sm:text-5xl font-headline font-bold text-white uppercase tracking-tighter">{aiPulses.toLocaleString()}</p>
                ...
                <Card className="sovereign-stats-card w-full sm:w-auto">
                    <div className="flex justify-between items-center mb-2 sm:mb-4">
                       <p className="text-[8px] sm:text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Digital Will Status</p>
                    </div>
                    <div className="flex items-end gap-2 mb-2 sm:mb-4">
                       <p className="text-3xl sm:text-4xl font-headline font-bold text-white uppercase tracking-tighter">PERPETUAL</p>
                    </div>
                    <div className="h-1.5 sm:h-2 bg-white/5 rounded-full overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3 space-y-8 sm:space-y-12">
               ...
               <section className="space-y-6">
                  <h3 className="text-[10px] sm:text-xs font-headline font-bold uppercase tracking-[0.4em] text-primary flex items-center gap-2">
                    ...
                    <CardContent className="p-4 sm:p-8 space-y-6 sm:space-y-8">
                      <div className="flex flex-col gap-4 sm:gap-6">
                        <div className="flex items-center gap-3 sm:gap-4">
                           ...
                           <p className="text-[10px] sm:text-sm font-bold text-white uppercase tracking-widest">Awaiting Command, Commander.</p>
                        </div>
                        ...
                        <div className="relative group">
                          ...
                          <input 
                            ...
                            className="w-full bg-black/60 border border-white/10 rounded-xl sm:rounded-2xl h-12 sm:h-16 pl-10 sm:pl-12 pr-12 sm:pr-16 text-sm sm:text-lg outline-none focus:ring-2 focus:ring-primary font-mono text-white transition-all"
                          />
                          <Button 
                        ...
                        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-700">
                          <div className="p-4 sm:p-6 bg-black/80 rounded-xl sm:rounded-2xl border border-primary/30 space-y-4 relative overflow-hidden">
                             ...
                             <div className="flex justify-between items-center relative z-10">
                                <Badge className="bg-primary/20 text-primary border-none text-[8px] sm:text-[10px] font-bold">DISPATCH: {aiResult.sourceModule}</Badge>
                                <span className="text-[8px] sm:text-[10px] text-muted-foreground font-mono uppercase tracking-widest">Veracity: 100%</span>
                             </div>
                             ...
                             <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 pt-4 sm:pt-6 border-t border-white/5 relative z-10">
                                {aiResult.dataPoints.map((dp, i) => (
                                  <div key={i} className="space-y-1">
                                     <p className="text-[8px] sm:text-[9px] text-muted-foreground uppercase font-bold tracking-widest">{dp.label}</p>
               ...
               <section className="space-y-6">
                  <h3 className="text-[10px] sm:text-xs font-headline font-bold uppercase tracking-[0.4em] text-emerald-500 flex items-center gap-2">
                          ...
                          <CardContent className="p-5 sm:p-6">
                             <div className="flex justify-between items-start">
                                <div className="space-y-1 sm:space-y-2">
                                   <p className="text-[8px] sm:text-[9px] font-bold text-muted-foreground uppercase tracking-widest">Protocol #{m.id}</p>
                                   <h4 className={`text-base sm:text-lg font-headline font-bold text-white uppercase ${m.color}`}>{m.label}</h4>
                                   <p className="text-xs text-muted-foreground italic leading-relaxed">"{m.desc}"</p>
                                </div>
                                <div className={`p-1.5 sm:p-2 rounded-lg bg-emerald-500/10 ${m.color}`}>
            ...
            <div className="space-y-6 sm:space-y-8">
               ...
               <Card className="glass-card border-amber-500/40 bg-amber-500/5 p-4 sm:p-6 flex flex-col items-center text-center gap-3 sm:gap-4 relative overflow-hidden">
                  <div className="absolute top-0 right-0 p-4 opacity-5">
                  ...
                  <div className="space-y-1 z-10">
                     <p className="text-[10px] sm:text-xs font-headline font-bold text-white uppercase tracking-widest">Family Shield</p>
                     <Badge className="bg-emerald-500 text-black border-none text-[7px] sm:text-[8px] font-bold">ALL_SYNCED</Badge>
                  </div>
                  <p className="text-[8px] sm:text-[10px] text-muted-foreground italic leading-relaxed z-10">
                    "Your family's digital assets are now protected by the 100-node Mesh."
                  </p>
                  <Link href="/citizen-portal" className="w-full z-10">
                    <Button variant="outline" className="w-full border-amber-500/20 text-amber-500 hover:bg-amber-500/10 text-[8px] sm:text-[9px] uppercase font-bold h-9">Manage Portal</Button>
                  </Link>
               </Card>
               ...
               <Card className="glass-card border-l-4 border-l-primary bg-primary/5">
                  ...
                  <CardContent className="p-4 pt-0 space-y-3">
                     <div className="p-2.5 bg-black/40 rounded-lg border border-white/5 flex justify-between items-center">
                        ...
                        <Badge className="bg-emerald-500/20 text-emerald-500 border-none text-[7px] sm:text-[8px]">ANCHORED</Badge>
                     </div>
                     <div className="p-2.5 bg-black/40 rounded-lg border border-white/5 flex justify-between items-center">
                        <span className="text-[8px] sm:text-[10px] text-muted-foreground uppercase">Digital Will</span>
                        <Badge className="bg-primary/20 text-primary border-none text-[7px] sm:text-[8px]">ACTIVE</Badge>
                     </div>
                  </CardContent>
               </Card>

               <Card className="glass-card flex flex-col h-[300px] sm:h-[400px]">
                <CardHeader className="p-4 border-b border-white/5 bg-white/2">
                  <CardTitle className="font-headline text-xs sm:text-base uppercase flex items-center gap-2">
                  ...
                  <ScrollArea className="h-full p-4">
                    <div className="space-y-3 sm:space-y-4">
                      {impactFeed.map((log, i) => (
                        <div key={i} className="p-2.5 sm:p-3 bg-white/2 rounded-lg sm:rounded-xl border border-white/5 font-mono text-[8px] sm:text-[10px] flex items-center gap-2 sm:gap-3 animate-in fade-in slide-in-from-right-2 duration-500">
                          <div className={`size-1 sm:size-1.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.5)] animate-pulse shrink-0`} />
