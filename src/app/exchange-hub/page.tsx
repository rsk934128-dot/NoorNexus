...
/**
 * @fileOverview Imperial Exchange Hub Page
 * This page integrates the binance-eosin app into the NoorNexus Sovereign OS.
 */
export default function ExchangeHubPage() {
  const refreshFrame = () => {
    const iframe = document.getElementById('exchange-iframe') as HTMLIFrameElement;
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <h2 className="text-xl sm:text-2xl font-headline font-bold uppercase tracking-tight text-primary truncate leading-none flex items-center gap-2">
                  Imperial Exchange Hub
                  <Sparkles className="size-4 text-amber-500 animate-pulse" />
                </h2>
                <div className="flex items-center gap-2 mt-1">
                  <p className="text-[10px] text-muted-foreground font-mono tracking-widest uppercase truncate">Sovereign Trading & Liquidity Node</p>
                </div>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <Badge variant="outline" className="hidden sm:flex border-emerald-500/50 text-emerald-500 uppercase items-center gap-1.5 h-7">
                ...
                <span className="text-[10px]">Market Live</span>
              </Badge>
              <Button 
                variant="ghost" 
                size="icon" 
              ...
              <a 
                href="https://binance-eosin.vercel.app/" 
                target="_blank" 
