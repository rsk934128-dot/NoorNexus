...
const REGIONAL_PROVIDERS = {
  ...
  europe: [
    ...
    { name: "GoCardless", banks: "2,228", countries: "54", url: "https://gocardless.com/" },
...
export default function OpenBankingHubPage() {
  ...
  const openInApp = (url: string) => {
    ...
    setTimeout(() => setLoadingView(false), 800)
  }

  const closeView = () => setActiveUrl(null)
        ...
        {activeUrl ? (
          <main className="flex flex-col h-screen w-full overflow-hidden p-0 m-0 animate-in fade-in zoom-in-95 duration-300">
                ...
                <div className="flex items-center gap-4">
                   ...
                   <div className="space-y-0.5">
                      <p className="text-xs font-bold text-white uppercase flex items-center gap-2">
                        ...
                        <Badge variant="outline" className="text-[7px] border-emerald-500/50 text-emerald-500">HMAC_V4_SECURE</Badge>
                      </p>
                      <p className="text-[10px] text-muted-foreground font-mono truncate max-w-[300px]">{activeUrl}</p>
                   </div>
                </div>
             ...
             <div className="flex-1 bg-white relative">
                {loadingView && (
                  <div className="absolute inset-0 z-10 bg-background flex flex-col items-center justify-center gap-4">
                     <Loader2 className="size-10 text-primary animate-spin" />
                     <p className="text-xs font-mono uppercase tracking-widest text-primary animate-pulse">Initializing Sovereign Canal...</p>
                  </div>
                )}
                <iframe 
                  src={activeUrl} 
